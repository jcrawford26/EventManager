...
with tab2:
    ...
    venue_name = st.text_input('Venue Name for Booking', key='booking_venue_name')
    if st.button('Create Booking', key='create_booking'):
        create_booking(client_name, date, start_time, end_time, venue_name)  # Assuming create_booking function handles exceptions and messages
